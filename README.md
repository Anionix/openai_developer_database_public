...
- `.github/workflows/dependency-review.yml`: SHA-pinned Dependency Review workflow for pull request dependency changes.
...
- Mutable or unapproved GitHub Actions workflow references.
